...
5. **Report + transcript** — Save `founder-council-report-[timestamp].html` and `founder-council-transcript-[timestamp].md` to the workspace. Lite mode skips the HTML.
...
- `founder-council-transcript-[timestamp].md` — durable record: PR/FAQ, all verdicts with flip lines, all peer reviews with A/B/C mapping revealed, Chairman synthesis.
